...
Reads scalability analysis results and produces log-scale running time plots
...
def load_running_times(data_dir, data_type, num_candidates_list):
    """Load Gurobi and Transformer running times from scalability analysis results."""
    gurobi_times = []
    transformer_times = []
    valid_candidates = []

    for nb_candidates in num_candidates_list:
        # Try loading from scalability analysis results first
        analysis_path = f"{data_dir}/analysis_data/fine_tuning/scalability/analysis_data_{nb_candidates}_{data_type}_fine_tuning.npy"
        ...
        gurobi_path = f"{data_dir}/gurobi/scalability/test_dataset_{nb_candidates}_{data_type}_kemeny_optimal_ranking_gurobi.npy"
        transformer_path = f"{data_dir}/transformer/fine_tuning/test_dataset_{nb_candidates}_{data_type}_transformer.npy"

...
def main():
    ...
    for num in num_items:
        ...
        print(f'test dataset repeat is all permutation={is_all_permutation}')
        os.system("mkdir -p data/test/ablation")
        np.save(f'data/test/ablation/test_dataset_random_{num}.npy',test_dataset_random)
        np.save(f'data/test/ablation/test_dataset_repeat_{num}.npy',test_dataset_repeat)
        np.save(f'data/test/ablation/test_dataset_jiggling_{num}.npy',test_dataset_jiggling)

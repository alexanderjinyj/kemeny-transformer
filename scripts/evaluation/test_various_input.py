...
def main():
    # Configuration
    config_file = "configs/args_700k_linear_various_voter_various_items_mix_batch.conf"
    checkpoint_file = "outputs/checkpoints/various_input_kemeny_transformer/linear_embedding/700k_various_voters_various_items_mix_batch_3_encoder_2_decoder_kemeny_transformer_without_guide/checkpoint_epoch_650.pkl"
    ...
    output_dir = Path("results/700k_various_voters_various_items_epoch_500")

...
def main(self):
    ...
    #np.save('data/validation/validate_dataset_random.npy',validate_dataset_random)
    ...
    np.save('data/validation/validate_dataset_repeat_jiggling.npy',validate_dataset_repeat_jiggling)
